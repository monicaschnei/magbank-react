...
const Dashboard = ({name, account}) => {
    ...
    history:[
        {date:'17/07', description:'SAQUE 24H 012345', value: '200,00', saldo: ''},
        {date:'17/07', description:'SALDO DO DIA', value: '',saldo: '2.780,00'},
        {date:'19/07', description:'ESTACIONAMENTO 123234', value: '12,00',saldo: ''},
        {date:'19/07', description:'COMPRA INTERNET 123432', value: '450,00', saldo:''},
        {date:'19/07', description:'SALDO DO DIA', value: '', saldo: '2.318,00'},
        {date:'21/07', description:'SUPERMERCADO 2312332', value: '275,90',saldo: ''},
        {date:'21/07', description:'ESTACIONAMENTO 123234', value: '12,00',saldo: ''},
        {date:'21/07', description:'SHOPPING 123432', value: '180,00', saldo:''},
        {date:'21/07', description:'SAQUE DO DIA', value: '', saldo: '1.851,00'},
        {date:'22/07', description:'SUPERMERCADO 2312332', value: '275,90',saldo: ''},
        {date:'22/07', description:'DEPÓSITO 123234', value: '1.000,00',saldo: ''},
